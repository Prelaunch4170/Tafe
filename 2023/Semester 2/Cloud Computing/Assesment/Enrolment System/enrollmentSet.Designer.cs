...
namespace Enrolment_System {
    ...
    public partial class enrollmentSet : global::System.Data.DataSet {
        ...
        public partial class EnrollmentDataTable : global::System.Data.TypedTableBase<EnrollmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EnrollmentRow AddEnrollmentRow(string courseID, string studentID, string grade) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EnrollmentRow FindBycourseIDstudentID(string courseID, string studentID) {
...
namespace Enrolment_System.enrollmentSetTableAdapters {
    ...
    public partial class EnrollmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Enrollment] WHERE (([courseID] = @Original_courseID) AND ([stu" +
                "dentID] = @Original_studentID) AND ((@IsNull_grade = 1 AND [grade] IS NULL) OR (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Enrollment] ([courseID], [studentID], [grade]) VALUES (@course" +
                "ID, @studentID, @grade);\r\nSELECT courseID, studentID, grade FROM Enrollment WHER" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Enrollment] SET [courseID] = @courseID, [studentID] = @studentID, [grade] = @grade WHERE (([courseID] = @Original_courseID) AND ([studentID] = @Original_studentID) AND ((@IsNull_grade = 1 AND [grade] IS NULL) OR ([grade] = @Original_grade)));
SELECT courseID, studentID, grade FROM Enrollment WHERE (courseID = @courseID) AND (studentID = @studentID)";
        ...
        public virtual int Delete(string Original_courseID, string Original_studentID, string Original_grade) {
        ...
        public virtual int Insert(string courseID, string studentID, string grade) {
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
        ...
        public virtual int Update(string courseID, string studentID, string grade, string Original_courseID, string Original_studentID, string Original_grade) {
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string grade, string Original_courseID, string Original_studentID, string Original_grade) {
            return this.Update(Original_courseID, Original_studentID, grade, Original_courseID, Original_studentID, Original_grade);
        }
    }
