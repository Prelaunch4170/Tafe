    ...
    public partial class EnrollmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Enrollment] SET [courseID] = @courseID, [studentID] = @studentID, [" +
                "grade] = @grade WHERE (([courseID] = @Original_courseID) AND ([studentID] = @Ori" +
                "ginal_studentID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["enrolmentSystemConnectionString2"].ConnectionString;
        }
        ...
        public virtual int Delete(string Original_courseID, string Original_studentID) {
        ...
        public virtual int Update(string courseID, string studentID, string grade, string Original_courseID, string Original_studentID) {
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string grade, string Original_courseID, string Original_studentID) {
            return this.Update(Original_courseID, Original_studentID, grade, Original_courseID, Original_studentID);
        }
    }
